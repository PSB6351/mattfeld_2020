Node: getbestvol (utility)
==========================


 Hierarchy : psb6351_wf.getbestvol
 Exec ID : getbestvol
...
* function_str : def best_vol(outlier_count):
    best_vol_num = outlier_count.index(min(outlier_count[:200]))
    if isinstance(best_vol_num, list):
        best_vol_num = best_vol_num[0]
    return best_vol_num

* outlier_count : /scratch/pvier002/mattfeld_2020/psb6351workdir/sub-021/psb6351_wf/id_outliers/outlier_file
...
* working_dir : /scratch/pvier002/mattfeld_2020/psb6351workdir/sub-021/psb6351_wf/getbestvol
