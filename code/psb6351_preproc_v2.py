...
#SBATCH -o /scratch/madlab/Mattfeld_PSB6351/Vanessa/crash/preproc_v2_o
#SBATCH -e /scratch/madlab/Mattfeld_PSB6351/Vanessa/crash/preproc_v2_e
...
id_outliers.inputs.legendre = True # testing our legendre and polort
id_outliers.inputs.polort = 3
...
volreg.inputs.interp = 'heptic' # testing heptic and quintic
...
datasink.inputs.base_directory = os.path.join(base_dir, 'derivatives/preproc_v2')
