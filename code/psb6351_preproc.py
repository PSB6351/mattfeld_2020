...
motion_dir = os.path.join(base_dir, f'derivative/preproc/sub-{sids[0]}/motion')
...
motion_files = sorted(glob(motion_dir + '/*.nii.gz'))
param_files = sorted(glob(motion_dir + '/*.1D'))
...
#ad.inputs.realigment_parameters = motion_par
